...
* Bucketing для стриминга в streamsets требуется, создал на основе поля hour,
  в реале там, конечно же, будут перекосы, но не слишком большие (в предалх одного часа)
