...
DROP TABLE SBX.ODS_OPER ;
DROP TABLE SBX.ETL_FILE_LOAD ;
DROP TABLE SBX.DDS_ST_PRODUCT_METRICS ;
DROP TABLE SBX.DDS_HUB_PRODUCT ;
*/

### -1. Create schema
#drop schema SBX cascade;
